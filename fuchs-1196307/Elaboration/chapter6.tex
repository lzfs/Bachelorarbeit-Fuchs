...
Setzt man im selben Beispiel den Threshold noch höher,
...
Die ermittelte Gesamtstandardabweichungen sind mit \emph{0.31} und \emph{0.12} auch um
...
Dieser Fall wurde lediglich aufgrund des hohen Thresholds einsortiert.
